...
# ---- HEADER ----
st.markdown("""
<div style='display: flex; align-items: center; background-color: #0e1117; padding: 0rem; border-radius: 10px; margin-none: 0rem;'>
    <img src='https://github.com/ResiliLytics/ResiliLytics-assets/blob/d3dc6cd2011816b6fe359d1867b286f4e7b07fa4/Logo%204.png?raw=true' alt='ResiliLytics Logo' width='100' style='margin-right: 30px;'/>
    <div>
        <h1 style='color: #fdf6e3; font-size: 4.0rem; margin: 0;'>ResiliLytics Dashboard</h1>
