...
if uploaded_file:
    ...
    st.markdown("""
<div style='background-color: #2a2f36; color: #ffffff; display: inline-block; padding: 8px 14px; border-radius: 6px; font-size: 2.5rem;'> Please upload a file to view dynamic metrics</div>""", unsafe_allow_html=True)
