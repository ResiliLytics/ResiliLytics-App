...
st.markdown("""
    <div style='text-align: center; padding: 0; margin: 0; line-height: 1;'>
        <img src='https://raw.githubusercontent.com/AuraFusion/supplysight-assets/main/logo.png' alt='SupplySight Logo' width='300' style='display: block; margin: 0 auto -2px auto;'/>
        <h1 style='color: #ffffff; margin: -0.2; padding: -0.2;'>SupplySight Dashboard</h1>
