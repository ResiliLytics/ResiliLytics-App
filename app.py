...
st.markdown("""
    <div style='text-align: center; padding: 0.5rem 0 0.5rem 0;'>
        <img src='https://raw.githubusercontent.com/AuraFusion/supplysight-assets/main/logo.png' alt='SupplySight Logo' width='100' style='margin-bottom:-10px;'/>
        <h1 style='color: #ffffff; margin: 0.5rem 0 0.2rem 0;'>SupplySight Dashboard</h1>
        <h3 style='color: #bbbbbb; font-weight:400; margin: 0;'>AI-powered SME Resilience & Risk</h3>
    </div>
